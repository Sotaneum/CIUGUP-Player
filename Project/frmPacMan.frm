...
Begin VB.Form frmPacMan 
   ...
   Begin VB.PictureBox pctStats 
      ...
      Begin VB.Label lblKeys 
         Alignment       =   2  '가운데 맞춤
         BackColor       =   &H00000000&
         Caption         =   "(I) 코인넣기   (1) 플레이1   (2) 플레이2   (E) 향샹모드   (S) 스피드설정   (Esc) 나가기"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  If KeyCode = vbKeyE And Game.Started = False Then
    ...
    If Game.Enhanced = True Then
      lblTitle.Caption = "향샹된 팩맨"
    Else
      lblTitle.Caption = "원본 팩맨"
    End If
  End If
  ...
  If KeyCode = vbKeyS And Game.Started = False Then
    ...
    Select Case Game.Speed
      Case 1
        lblSpeed.Caption = "보통 속도"
      Case 2
        lblSpeed.Caption = "터보 속도 !"
      Case 4
       lblSpeed.Caption = "미친 속도 !!"
    End Select
  End If
...
Private Sub ShowCoins()
  ...
  If Game.Coins <> 1 Then
    lblCoins.Caption = CStr(Game.Coins) & " 코인"
  Else
    lblCoins.Caption = "1 코인"
  End If
  ...
  Select Case Game.Coins
    Case 0
      lblPlayers.Caption = ""
    Case 1
      lblPlayers.Caption = "오직 1인용"
    Case Else
      lblPlayers.Caption = "1 또는 2을 눌러 시작"
  End Select
...
Shell "explorer http://gnyontu39.dothome.co.kr/1/jhomepage2/"
...
Private Sub tmrReady_Timer()
  ...
  If (Counter And 1) = 1 Then
    ...
    If Game.Players = 2 Then
      lblPlayer.Caption = "시작 ! " & CStr(Game.CurrentPlay + 1)
    End If
  Else
    lblReady.Caption = ""
    lblPlayer.Caption = ""
